...
libraries to send and receive HTTP messages to URL's. In this project,
i practiced sending `GET` and `POST` requests,
fetching JSON resources, and interacting with API's (the Star Wars API, GitHub API, and Twitter API).
