...
/**
 * print_python_float - function that gives data of the PyFloatObject.
 * @p: the PyObject.
 */
...
void print_python_list(PyObject *p)
{
	...
	if (PyList_CheckExact(p))
	{
		...
		while (y < size)
		{
			item = PyList_GET_ITEM(p, y);
			printf("Element %d: %s\n", y, item->ob_type->tp_name);
